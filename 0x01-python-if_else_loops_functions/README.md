...
Projects done during **Full Stack Software Engineering studies** at **ALX - Africa**. It aims to learn about if/else statements, loops, range and functions in **Python**.
